...
type DeleteCardHandlerFunc func(DeleteCardParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteCardHandlerFunc) Handle(params DeleteCardParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// DeleteCardHandler interface for that can handle valid delete card params
type DeleteCardHandler interface {
	Handle(DeleteCardParams, interface{}) middleware.Responder
}
...
/*
	DeleteCard swagger:route DELETE /card/{cardNumber} card deleteCard
